...
cites exact ground-truth references; the blocking checkpoint's 11 verification steps all pass, step 12's gap
ledger (now items a-g, ROUND 5/V8/V13) is explicitly recorded (not silently skipped), and step 13's
maintainer-annotation note is recorded — 13 numbered steps total (ROUND 5/V11 count fix).
</verification>
...
pass (W1), and Undo's refresh + content-identity "(NEW)" keying surviving a real reindex (W2).
</success_criteria>
