...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <resume-signal>Type "approved" once all 10 verification checks (steps 1-10) hold AND the gap ledger (step 11)
  AND the maintainer annotation note (step 12) have been recorded — 12 numbered steps total, ROUND-3-REVIEW
  R13/Opus L5 — or describe which check failed / which sketch element is missing / which gap-ledger item behaved
...
note in Plan 13's own must_haves — sign-off does not silently pass over either.
</success_criteria>
