...
<task type="auto">
  ...
  <read_first>
    ...
    payload (400-1024 -- CAPTURE_BUILDING_TEMPLATE occupies 768..1024, ROUND-3-REVIEW R13/Fable L4), so correctness depends ENTIRELY on being written/read inside the existing seqlock span,
